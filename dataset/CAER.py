...
class CAER(Dataset):
    def __init__(
        self,
        data_dir: str = '/home/dazzy/Downloads/CAER-S',
        split: Literal['train', 'test'] = 'train',
        target: Literal['number', 'string'] = 'string',
    ):
        super().__init__()
        ...
        self.preprocesser = T.Compose([
            ...
            T.ToTensor(),
            T.Normalize((0.2820989, 0.21251749, 0.19766633), (0.1755151, 0.15340067, 0.15228797)),
        ])
    ...
    def __getitem__(self, i):
        ...
        img = F.normalize(
            ...
            mean=[0.2820989, 0.21251749, 0.19766633],
            std=[0.1755151, 0.15340067, 0.15228797]
        ).float()
